function noCan()
			{
				if(event.button==2||event.button==3||event.ctrlKey)
				{
					alert('Código protegído!');
				}
...
function noCan()
{
	if(event.button == 2||event.button==3||event.ctrlKey)
	{
		alert("Proibido este tipo de coisa!");
	}
