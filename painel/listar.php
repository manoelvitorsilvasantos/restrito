	...
	<body>
		...
		<div class="conteiner">
			...
			<div class="item conteudo">
				<h3 style="text-align:center;">Dados do Cliente</h3><br>
				...
				<?php
					...
					//maximo de links.
					$max_links = 2;
					echo(" <a style='background:#000000; padding:10px; border-radius:5px;color:white;text-decoration:none;' href='listar?pagina=1'>Inicio</a> | ");
					for($pag_ant = $pagina-$max_links;$pag_ant <= $pagina-1;$pag_ant++){
						if($pag_ant >= 1){
							echo(" <a style='background:#000000; padding:10px; border-radius:5px;color:white;text-decoration:none;' href='listar?pagina=$pag_ant'>$pag_ant</a> | ");
						}
					}
					echo("<span style='background:#000000; padding:10px; border-radius:5px;color:white;text-decoration:none;'>$pagina</span> | ");
					echo(" <a style='background:#000000; padding:10px; border-radius:5px;color:white;text-decoration:none;' href='listar?pagina=$quantidade'>Ultima</a> ");
					echo("<br><br>");
				?>
			</div>
		</div>
